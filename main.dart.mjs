...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1564: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1565: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1584: (x0,x1) => x0.append(x1),
      _1585: (x0,x1) => x0.append(x1),
      _1586: x0 => ({xhrSetup: x0}),
      _1587: x0 => new Hls(x0),
      _1588: () => globalThis.Hls.isSupported(),
      _1590: (x0,x1) => x0.loadSource(x1),
      _1591: (x0,x1) => x0.attachMedia(x1),
      _1592: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1593: x0 => x0.pause(),
      _1594: (x0,x1) => x0.end(x1),
      _1597: x0 => x0.play(),
      _1601: (x0,x1) => x0.canPlayType(x1),
      _1602: x0 => x0.random(),
      ...
      _1775: (x0,x1) => { x0.draggable = x1 },
      _1791: x0 => x0.style,
      _2363: x0 => x0.videoWidth,
      _2364: x0 => x0.videoHeight,
      _2393: x0 => x0.error,
      _2395: (x0,x1) => { x0.src = x1 },
      _2404: x0 => x0.buffered,
      _2407: x0 => x0.currentTime,
      _2408: (x0,x1) => { x0.currentTime = x1 },
      _2409: x0 => x0.duration,
      _2413: x0 => x0.playbackRate,
      _2425: (x0,x1) => { x0.controls = x1 },
      _2426: x0 => x0.volume,
      _2427: (x0,x1) => { x0.volume = x1 },
      _2428: x0 => x0.muted,
      _2429: (x0,x1) => { x0.muted = x1 },
      _2445: x0 => x0.message,
      _2519: x0 => x0.length,
      ...
      _3023: (x0,x1) => { x0.src = x1 },
      _3025: (x0,x1) => { x0.type = x1 },
      _3029: (x0,x1) => { x0.async = x1 },
      _3043: (x0,x1) => { x0.charset = x1 },
      _3492: () => globalThis.window,
      _3555: x0 => x0.navigator,
      _3944: x0 => x0.userAgent,
      _6160: x0 => x0.firstChild,
      _6171: () => globalThis.document,
      _6254: x0 => x0.head,
      _6587: (x0,x1) => { x0.id = x1 },
      _6611: (x0,x1) => { x0.innerHTML = x1 },
      ...
      _8129: x0 => x0.length,
      _8134: x0 => x0.result,
      _10765: (x0,x1) => { x0.border = x1 },
      _11043: (x0,x1) => { x0.display = x1 },
      _11207: (x0,x1) => { x0.height = x1 },
      _11897: (x0,x1) => { x0.width = x1 },
      _12266: x0 => x0.message,
